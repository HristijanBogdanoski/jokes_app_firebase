  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.teal, // Set to turquoise (teal)
        elevation: 5,
      ),
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [Colors.teal, Colors.tealAccent], // Turquoise gradient
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            const Icon(Icons.sentiment_satisfied_alt,
                                color: Colors.teal), // Icon in turquoise
                            const SizedBox(width: 8),
                            Expanded(
                              child: Text(
                                joke.setup,
                                style: const TextStyle(
                                  fontSize: 18, // Adjusted size to match the other screen
                        ...
                        Text(
                          joke.punchline,
                          style: const TextStyle(
                            fontSize: 16, // Adjusted size to match the other screen
                        ...
                        ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: Colors.lightGreen, // Turquoise button
